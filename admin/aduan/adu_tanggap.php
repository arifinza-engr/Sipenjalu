<style>
  ...
  #aduMenunggu thead tr th:first-child {
    border-radius: 10px 0 0 10px;
  }

  #aduMenunggu thead tr th:last-child {
    border-radius: 0 10px 10px 0;
  }

  #aduMenunggu tbody tr td {
  ...
  #aduMenunggu tbody tr:hover td {
    background: var(--bg-row-hover);
  }

  #aduMenunggu tbody tr:last-child td {
    border-bottom: none;
  }
...
<div class="aduan-panel">
  ...
  <div class="aduan-header">
    <div class="aduan-header-left">
      ...
      <div>
        <h5>Aduan Dalam Proses</h5>
        <p>Kelola laporan pengaduan yang sedang diproses</p>
      </div>
    </div>
  ...
  <div class="aduan-body">
    <div class="table-responsive">
      <table class="table" id="aduMenunggu">
        <thead>
          <tr>
            <th>No</th>
            <th>Pengadu</th>
        ...
        <tbody>
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><span class='sub-text'>{$row['judul']}</span></td>";
  ...
  $(document).ready(function() {
    var table = $('#aduMenunggu').DataTable({
      ...
      buttons: [{
        extend: 'excel',
        text: 'Export Excel',
        title: 'Daftar Aduan Dalam Proses'
      }]
    });
