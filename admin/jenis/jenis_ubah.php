...
<div class="aduan-panel">
  ...
  <div class="aduan-header">
    <div class="aduan-header-left">
      ...
      <div>
        <h5>Ubah Jenis Aduan</h5>
        <p>Edit kategori jenis pengaduan</p>
      </div>
    </div>
  </div>
  ...
  <div class="aduan-body">
    <form method="POST">
      <!-- Hidden input -->
      <input type='hidden' name="id_jenis" value="<?php echo $data_cek['id_jenis']; ?>">

      <div class="form-group">
        <label for="jenisInput" class="form-label">Nama Jenis</label>
        <input type="text" class="form-control" id="jenisInput" name="jenis" value="<?php echo $data_cek['jenis']; ?>" placeholder="Masukkan nama jenis aduan..." required>
      </div>
      <div class="btn-group">
